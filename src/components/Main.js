...
import {filmovi, serije, crtaniFilmovi, muzika, emisije, sport, reklame} from "../data/youtube_ids"
...
class Main extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      // filmovi
      filmovi: [
        {boolean: true}, filmovi],
      // serije
      serije: [
        {boolean: true}, serije],
      // crtani filmovi
      crtaniFilmovi: [
        {boolean: true},crtaniFilmovi],
      // muzika
      muzika: [
        {boolean: true},muzika],
      // emisije
      emisije: [
        {boolean: true},emisije],
      // sport
      sport: [
        {boolean: true},sport],
      // reklame
      reklame: [
        {boolean: true},reklame]
    };
  ...
  changeChannel() {
    ...
    if (this.state.filmovi[0].boolean) allChannelsPool.push(this.state.filmovi[1])
    if (this.state.serije[0].boolean) allChannelsPool.push(this.state.serije[1])
    if (this.state.crtaniFilmovi[0].boolean) allChannelsPool.push(this.state.crtaniFilmovi[1])
    if (this.state.muzika[0].boolean) allChannelsPool.push(this.state.muzika[1])
    if (this.state.emisije[0].boolean) allChannelsPool.push(this.state.emisije[1])
    if (this.state.sport[0].boolean) allChannelsPool.push(this.state.sport[1])
    if (this.state.reklame[0].boolean) allChannelsPool.push(this.state.reklame[1])
    ...
    finalChannel = Math.floor(Math.random() * merged.length)
        ...
        <div className="mainContainer">
          ...
          <div className="remote">
            ...
            <div className="remote__buttonsContainer">
              <button onClick={this.changeCategory} value="filmovi">Filmovi</button>
              <button onClick={this.changeCategory} value="serije">Serije</button>
              <button onClick={this.changeCategory} value="crtaniFilmovi">Crtani Filmovi</button>
              <button onClick={this.changeCategory} value="muzika">Muzika</button>
              <button onClick={this.changeCategory} value="emisije">Emisije</button>
              <button onClick={this.changeCategory} value="sport">Sport</button>
              <button onClick={this.changeCategory} value="reklame">Reklame</button>
              ...
              <button className=" buttonEffectContainerButton" onClick={this.effectsToggle}>iskljuci efekte</button>
              <button className=" buttonBackgroundContainerButton" onClick={this.backgroundChange}>promeni pozadinu</button>
